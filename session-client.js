(function(){'use strict';
 function create(){
  ...
  function open(plan,brief,calculation,reasoning,coreId=null,target=null){
   const draft={schema:'problem-atom/selection-draft/1',plan,brief,calculation,reasoning,coreId,target};
