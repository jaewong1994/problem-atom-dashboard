...
수식은 $...$ 또는 $$...$$로 표기한다. 출력은 지정 JSON 형식만 사용한다.`;
 ...
 return {RESULT_SCHEMA,INSTRUCTIONS,makeRequest,handoff,validateResult,schemaErrors};
});
