...
const SHELL = [
  "./studio.html", "./connections.html", "./connections.css?v=io1", "./connections.js?v=cards1", "./connection-engine.js?v=design2", "./connection-registry.json",
  "./curriculum-model.js?v=unit1", "./unit-ui.js?v=unit1", "./units.css?v=unit1", "./judgment-bundles.js?v=unit1", "./authoring-model.js?v=unit1", "./authoring-ui.js?v=cards1", "./authoring.css?v=cards1", "./authoring-lessons.json",
  "./web-handoff.js?v=unit1", "./production-io.js?v=io1", "./composition-graph.js?v=map1", "./box-copy.js?v=examples1", "./box-examples.js?v=cards1", "./composition-planner.js?v=unit1", "./model-contract.js?v=unit1", "./selection-model.js?v=map1", "./session-client.js?v=unit1", "./model-provider.json",
