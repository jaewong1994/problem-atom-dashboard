...
const SHELL = [
  ...
  "./web-handoff.js?v=unit1", "./production-io.js?v=io1", "./composition-graph.js?v=map1", "./box-copy.js?v=examples1", "./box-examples.js?v=cards1", "./composition-planner.js?v=unit1", "./model-contract.js?v=review1", "./selection-model.js?v=map1", "./session-client.js?v=review1", "./model-provider.json",
  "./review-groups.json", "./group-review-ledger.json", "./group-review.js?v=review1", "./review-model.js?v=review1", "./review-client.js?v=review1", "./review-link.css?v=review1", "./review-catalog.json", "./sandbox.css",
