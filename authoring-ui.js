(function(root){'use strict';
 const A=root.PAAuthoring,C=root.PABoxCopy,G=root.PAGraph,B=root.PABundles,U=root.PACurriculum;
 ...
 function mount(host,{example}){
  let ctx,selected=null,expandedGoals=false,lastIds=new Set(),hasRendered=false,arrivalIds=new Set(),arrivalUntil=0,drawFrame,libraryMode="bundles",libraryTerm="",libraryLimit=8,lastScope="";const expandedBundles=new Set();
